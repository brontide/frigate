...
class MoG2MotionDetector(MotionDetector):
    def __init__(
        ...
        # Contrast adjustment tracking (kept from improved_motion, disabled below)
    ...
    def is_calibrating(self):
        # MOG2 builds its own background model; report not calibrating after
        # a short warmup period so Frigate doesn't suppress early detections forever.
